...
public:
	...
	cv::Mat_<uchar> readSharpScaledImage() const {
		std::string path = base_path + "/blurred/" + "cam0" + "/" + "1.png";
...
int main(int argc, const char** argv)
{
	...
	posest::Dataset dataset("/home/johann/motion-blur-cam-pose-tracker/semester-thesis/RelisticRendering-dataset", 2);
